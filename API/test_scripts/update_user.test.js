...
describe('Update User API Tests', () => {
    ...
    // // 2. Partial Update - should handle partial updates successfully
    //test passed but I am waiting for messages mismatch first
    // it('should handle partial updates successfully (update only email)', async () => {
